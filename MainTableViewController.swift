...
class MainTableViewController: UITableViewController { //메모장 MAIN TableViewController
    ...
    let formatter: DateFormatter = { //현재 날짜와 시간 생성
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let cell = sender as? UITableViewCell, let indexPath = myTableView.indexPath(for: cell) { //메모 보기에 값 넘겨주기 위해 segue 설정
